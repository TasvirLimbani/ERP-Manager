...
export default function ProfilePage() {
  ...
  return (
    <div className="flex min-h-screen w-full items-center justify-center bg-gradient-to-br from-slate-100 via-muted to-slate-200 p-4">      <Card className="w-full max-w-md rounded-3xl shadow-2xl overflow-hidden border border-white/40 backdrop-blur">

      {/* Header */}
      <div className="pt-10 from-primary" />
