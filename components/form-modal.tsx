                      ...
                      field.type === 'select' ? (
                        <select
                          value={field.value ?? dropFormData[field.name] ?? ''} onChange={(e) => {
                            ...
                            if (field.onChange) {
                              field.onChange(value)   // ✅ this triggers handleYarnChange
                            }
...
//       <Card className="relative w-full max-w-md border border-border/50 bg-card shadow-lg max-h-[95vh] sm:max-h-[90vh] flex flex-col rounded-xl">
...
//                         handleChangedrop(field.name, val)
//                         field.onChange?.(val)
//                       }}
//                        readOnly={field.readOnly}
//                           disabled={field.disabled}
